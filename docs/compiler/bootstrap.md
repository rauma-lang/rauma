...
v0.0.9g-fix completes the controlled fixed-point candidate chain for
`rmb/tests/rmc_candidate/main.rm`: `rmb -> rmc0 -> rmc1 -> rmc2 -> rmc3`.
The candidate generations match behavior for the supported commands, and the
